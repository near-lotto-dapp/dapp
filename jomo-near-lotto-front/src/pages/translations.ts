export const translations = {
    en: {
        ...
        transparencyDesc: "JOMO Pool Shares is a non-custodial decentralized application. Every pool code purchase and jackpot draw is recorded permanently on the NEAR blockchain.",
    ...
    ua: {
        ...
        transparencyDesc: "JOMO Pool Shares — це децентралізований додаток. Кожна купівля pool code та розіграш джекпоту назавжди записуються в блокчейн NEAR.",
